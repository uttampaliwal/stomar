...
class TestBuyAndHold:
    def test_cumulative_return(self):
        from src.signals.benchmarks import buy_and_hold
...
class TestMomentum20D:
    def test_signals_positive_momentum(self):
        from src.signals.benchmarks import momentum_20d
...
class TestAlwaysLong:
    def test_accuracy_is_fraction_positive(self):
        from src.signals.benchmarks import always_long
...
class TestRandomStrategy:
    def test_deterministic(self):
        from src.signals.benchmarks import random_strategy
...
class TestSmaCrossover:
    def test_bullish_trend(self):
        from src.signals.benchmarks import sma_crossover
...
class TestCompareToBenchmarks:
    def test_returns_list_sorted_by_sharpe(self):
        from src.signals.benchmarks import compare_to_benchmarks
