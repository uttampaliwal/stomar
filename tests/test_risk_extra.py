...
class TestFixedFractionSizing:
    def test_basic_sizing(self):
        from src.trading.risk import fixed_fraction_sizing
...
class TestVolatilityPositionSize:
    def test_basic_sizing(self):
        from src.trading.risk import volatility_position_size
...
class TestCalculateMaxDrawdown:
    def test_monotonic_increase(self):
        from src.trading.risk import calculate_max_drawdown
...
class TestCalculateCalmar:
    def test_basic_calmar(self):
        from src.trading.risk import calculate_calmar
...
class TestPortfolioVar:
    def test_basic_portfolio_var(self):
        from src.trading.risk import portfolio_var
...
class TestMaxPositionValue:
    def test_basic_max_position(self):
        from src.trading.risk import max_position_value
...
class TestCheckPortfolioRisk:
    def test_basic_check(self):
        from src.trading.risk import check_portfolio_risk
...
class TestGenerateRiskReport:
    def test_report_has_all_keys(self, sample_returns):
        from src.trading.risk import generate_risk_report
