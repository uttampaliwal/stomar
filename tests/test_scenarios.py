...
class TestRegimeAllocation:
    def test_bull_allocation(self):
        from src.signals.regime_strategy import get_regime_allocation
...
class TestRegimePositionSize:
    def test_bull_larger(self):
        from src.signals.regime_strategy import regime_adjusted_position_size
...
class TestBacktestRegimeStrategy:
    def test_returns_all_keys(self):
        from src.signals.regime_strategy import backtest_regime_strategy
        df = _make_df()
...
class TestScenarios:
    def test_buy_and_hold(self):
        from src.signals.scenarios import scenario_buy_and_hold
        df = _make_df()
    ...
    def test_momentum(self):
        from src.signals.scenarios import scenario_momentum
        df = _make_df()
